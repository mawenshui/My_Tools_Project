...
public:
	...
	*/
    ...
    void SetUIntValue( unsigned val );
    ///< Set the value from an integer.
    void SetlonglongValue(unsigned long long  _value );										///< Set the value from an integer.
...
public:
	...
	*/
    ...
    ///< STL std::string form.
    void SetAttribute( const std::string& name, long long _value );
    ///< STL std::string form.
